$(function() {
  ...
  if($('#chartjsDoughnut').length) {
    new Chart($('#chartjsDoughnut'), {
      type: 'doughnut',
      data: {
        labels: ["No Barcode", "Weight not matching", "Color not matching", "Too dirty"],
        datasets: [
          {
            label: "Population (millions)",
            backgroundColor: [colors.primary, colors.danger, colors.info, colors.warning],
            borderColor: colors.cardBg,
            data: [2478,4267,1334,500],
          }
        ]
      },
      options: {
  ...
  if($('#chartjsPie').length) {
    new Chart($('#chartjsPie'), {
      type: 'pie',
      data: {
        labels: ["Jammed shredder", "Power cut", "Other"],
        datasets: [{
          label: "Population (millions)",
  ...
  if($('#chartjsGroupedBar').length) {
    new Chart($('#chartjsGroupedBar'), {
      type: 'bar',
      data: {
        labels: ["Mon", "Tue", "Wed", "Thi", "Fri", "Sat"],
        datasets: [
          {
            label: "Clear bottles",
            backgroundColor: colors.warning,
            data: [133,221,783,1478,512,135]
          }, {
            label: "Light Blue",
            backgroundColor: colors.primary,
            data: [408,547,675,734,430,789]
          },
          {
            label: "Others",
            backgroundColor: colors.success,
            data: [408,547,675,734,140,560]
          }
        ]
      },
      options: {
 ...
 // Grouped Bar Chart
 if($('#tannage-collected').length) {
  new Chart($('#tannage-collected'), {
    type: 'bar',
    data: {
      labels: ["Mon", "Tue", "Wed", "Thi", "Fri", "Sat"],
      datasets: [
